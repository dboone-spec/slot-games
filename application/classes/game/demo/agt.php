   ...
   public function gamble_stats() {
     ...
     public function init()
    {
        ...
        foreach($this->_config['lines_choose'] as $lines_count) {
            $full_bets[$lines_count]=[0.5,1,2,5,10,20,50,100,150,200,250,500,1000,1500,2000,2500,5000];
        }
        ...
        $a= ["balance"   => 100 * ($this->amount() - $this->_session['win']),
                ...
                "lines"     => array_values($this->_config['lines']),
...
//        array_shift($this->_session['lv']);
        ...
        else
        {
			...
			$this->_calc->setTotalFreeCount($this->_session['freeCountAll']);
