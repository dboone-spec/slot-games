...
class Controller_Admin1_Operation extends Super {
    ...
    public function configure() {
        ...
        $id = new Vidget_Balance('office_amount', $this->model);
        $this->vidgets['office_amount'] = $id;

        $id = new Vidget_Balance('before', $this->model);
        $this->vidgets['before'] = $id;

        $id = new Vidget_Balance('after', $this->model);
        $this->vidgets['after'] = $id;
