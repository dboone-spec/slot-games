...
class Controller_Admin1_Reportlocal extends Controller_Admin1_Base
{
    ...
    public function action_index()
    {
        ...
        $data=[];
        $totalOffice=[];
        $total=['in'=>0,'cfsin'=>0,'lfsin'=>0,'afsin'=>0,'out'=>0,'count'=>0,'win'=>0, 'offices'=>[],'rtp'=>0, 'currencies'=>[]];
        ...
        foreach($statistic as $row){
            ...
            if (isset($totalOffice[$row['date']])){
                ...
                $totalOffice[$row['date']]['lfsin']+=$row['lfsin'];
        ...
        $view=new View('admin1/report/local');
