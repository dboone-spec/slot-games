        ...
        <div class="popup-border">
            ...
            <div class="popup-center">
                <?php if (auth::user()->bonus > 0) : ?>
                    <div class="user-bar__block _cash">
                        <div class="user-bar__data">
                            <div class="user-bar__data">Бонусов:</div>
                            <div class="user-bar__data-value">
                                <a href="#"><?php echo number_format(auth::user()->bonus, 2) ?> <?php echo auth::user()->currency(); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif ?>
                ...
                <?php if (auth::user()->bonusbreak > 0) : ?>
                    <div class="user-bar__block _points  disabled" style="margin-top: 15px;">
                        <div class="user-bar__data">
