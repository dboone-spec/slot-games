...
<html lang="">
        ...
        <style>
            ...
            @media (orientation: portrait) {
                #bottomBg {
                    ...
                    z-index: 1;
                    display: block;
                    background-image: url(/games/egt/images/games/<?php echo $name; ?>/ui/back_vert_bottom.png);
                ...
                #topButtons span {
                    background-image: url("/games/egt/images/themes/<?php echo $theme; ?>/buttons/top/mobile.png");
    ...
    <body>
        ...
        <div id="bottomBg">
            <!--<img width="100%" src="/games/egt/images/megahot20/ui/back_vert_bottom.png" />-->
        </div>
        <img id="gamble-btn" onmouseup="javascript:startGamble()" src="/games/egt/images/themes/<?php echo $theme; ?>/buttons/mobile/x2_vert.png" />
        <img id="spin-btn" ontouchstart="startGO();" ontouchend="spinGO();" src="/games/egt/images/themes/<?php echo $theme; ?>/buttons/mobile/spin_vert.png" />
