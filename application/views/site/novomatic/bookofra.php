...
<head>
	...
	<link rel="apple-touch-icon" sizes="100x100" href="apple-touch-icon.png" />
    <link rel="stylesheet" href="../common/css/style.css?ver=<?php echo th::ver(); ?>">
    <script>
        window.gameid = 'bookofra';
        static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
    <?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
	<script src="bookofra.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
...
@font-face {
	font-family: 'hobostd';
	src: url('../common/fonts/hobostd.ttf') format('truetype');
}
...
.block-wrap {
	...
	<div id="font-preload">
		...
		<span style="font-family: 'hobostd'">abc</span>
	</div>
    <div class="wrapper">
