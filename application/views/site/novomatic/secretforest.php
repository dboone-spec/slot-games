...
<head>
	...
	<style>
		...
		@font-face {
			font-family:'SYSTEM9';
			src: url('../common/fonts/9SYSTEMA.TTF');
		}
        @font-face {
            font-family:'ParisianCRegular';
            src: url('../common/fonts/SouvenirBold.ttf');
        }
		div#den {
			color: #ffff00;
		}
        ...
        <script>
                window.gameid = 'secretforest';
                static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
	<?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
	<script src="secretforest.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
...
<body>
	...
	<div id="font-preload">
		...
		<span style="font-family:SYSTEM9">abc</span>
		<span style="font-family:ParisianCRegular">abc</span>
	</div>
    <div class="wrapper">
