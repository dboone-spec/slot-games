...
<head>
	...
	<link rel="stylesheet" href="../common/css/style.css?ver=<?php echo th::ver(); ?>">
        ...
        <script>
                window.gameid = 'richesofindia';
                static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
	<?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
    <script src="richesofindia.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
	...
	<div class="wrapper">
		<div class="canvas-container">
			...
			<div id="bet-line" class="btn">
				<span id="bet-lineName" style="width: 33%; top: 44%; line-height: 1; left: 10%;"><?php echo __('Ставка&nbsp;Линии') ?></span>
