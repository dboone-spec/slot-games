...
<head>
	...
	<link rel="stylesheet" href="../common/css/style.css?ver=<?php echo th::ver(); ?>">
        ...
        <script>
                window.gameid = 'royaltreasures';
                static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
	<?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
	<script src="royaltreasures.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
...
<body>
	...
	@font-face {
		...
		src: url('../common/fonts/A101HLVB.ttf') format('truetype');
	}
	@font-face {
		font-family: 'kokilab';
		src: url('../common/fonts/kokilab.ttf') format('truetype');
	}
	@font-face {
		font-family: 'digital-7mono';
		src: url('../common/fonts/ilfb6hjh-webfont.ttf') format('truetype');
	}

	.block-wrap {
		background: #000000 url('images/splashscreen.jpg') no-repeat fixed center center / 88%;
	}
	...
	<script>
//		document.getElementById('gameStyles').disabled = true;
	</script>
	...
	<div id="font-preload">
		...
		<span style="font-family:kokilab">abc</span>
