...
<html lang="ru">
<head>
    <title>Lucky Lady's Charm</title>
    <meta charset="utf-8">
	...
	<style>
		@font-face {
			font-family:'hobostd';
			src: url('../common/fonts/hobostd.ttf');
		}
        ...
        <script>
                window.gameid = 'luckyladycharm';
                static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
	<?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
	<script src="luckyladycharm.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
