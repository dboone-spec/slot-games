            ...
            <div id="game-box">
                <div id="modal-window" class="load1">
                    <div id="box-rotate">
                        ...
                        <?php if(count($fs=auth::user()->game_freespins('columbusd'))): ?>
...
<script src="columbusd.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
<?php else: ?>
<script>
