...
<head>
	...
	<style>
        ...
        @font-face {
            font-family:'Marta';
            src: url('../common/fonts/MartaBold.otf');
        }
        @font-face {
            font-family:'Champions';
            src: url('../common/fonts/Champions.ttf');
        }
		div#den {
			color: #ffff00;
		}
        ...
        <script>
                window.gameid = 'marcopolo';
                static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
	<?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
	<script src="marcopolo.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
...
<body>
	<div id="font-preload">
		...
		<span style="font-family:Marta">abc</span>
		<span style="font-family:Champions">abc</span>
	</div>
    <div class="wrapper">
