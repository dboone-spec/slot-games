...
<head>
	...
	@font-face {
		...
		@font-face {
			...
			src: url('../common/fonts/systembold.ttf');
		}
		@font-face {
            font-family: 'digital-7mono';
            src: url('../common/fonts/ilfb6hjh-webfont.ttf');
        }
		@font-face {
			font-family:'Archive';
			src: url('../common/fonts/Archive.ttf');
		}
		@font-face {
			font-family:'blzee';
			src: url('../common/fonts/blzee.ttf');
		}
		@font-face {
			font-family:'Humnst';
			src: url('../common/fonts/Humnst.ttf');
		}
		@font-face {
			font-family:"Open Sans Extrabold";
			src: url("../common/fonts/OpenSans-ExtraBold.ttf") format("truetype");
		}
		.block-wrap {
        ...
        <script>
                window.gameid = 'oliversbar';
                static_domain = '<?php echo kohana::$config->load('static.static_domain'); ?>';
	</script>
	<?php if(Kohana::$environment==Kohana::PRODUCTION): ?>
	<script src="oliversbar.min.js?ver=<?=th::ver()?>" type="text/javascript"></script>
	<?php else: ?>
	<script>
