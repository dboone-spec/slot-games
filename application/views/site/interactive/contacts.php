				...
				<div class="container">
					...
					<div class="row py-4">
						<div class="col-lg-6">
							...
							<form id="contactForm" class="contact-form" action="/interactive/send" method="POST">
						...
						<div class="col-lg-6">
							...
							<div class="appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="800" style="animation-delay: 800ms;">
								...
								<ul class="list list-icons list-icons-style-2 mt-2">
									<li>&nbsp;</li>
									<li><i class="fas fa-phone top-6"></i> <strong class="text-dark">Telegram:</strong> <a href="https://t.me/site-domain">site-domain</a> </li>
									<li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a href="mailto:site-domaininfo@gmail.com">site-domaininfo@gmail.com</a></li>
                                                                        <li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address:</strong> Lizuma iela 1 k-11, LV-1006 Riga, Latvia</li>
								</ul>
							</div>
