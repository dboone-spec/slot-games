            ...
            <div class="container flex header__container">
                ...
                <div class="header__wrapper">
                    <div class="flex header_wrap mobile-hide">
                        <button class="header__top-menu-btn header__volume-btn" configkey="playsound" checked onclick="this.checked=!(this.checked || moonGame.getConfig('playsound')=='1'); moonGame.setConfig('playsound',+this.checked); moonGame.initConfig();">
                        ...
                        <button class="header__music-btn" configkey="musicbgnum" checked onclick="this.checked=!(this.checked || parseInt(moonGame.getConfig('musicbgnum'))>0); moonGame.setConfig('musicbgnum',+this.checked);moonGame.initConfig();" val="0">
                                ...
                                <div class="flex content-top__control-panel-inner">
                                    <div class="flex bet-auto-group">
                                        <div class="flex control-panel__cash-out-ctrl control-panel__cash-out-ctrl-1" data-target="panel-one">
                                            ...
                                            <div class="auto-cash-wrapper auto-cash-input" style="display: none;">
                                                <button class="bet-increment number-minus auto-cash-out-inc">
                                                ...
                                                <button class="bet-increment number-plus auto-cash-out-inc">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewbox="0 0 10 10">
                                    ...
                                    <div class="flex bet-control-wrap">
                                        <div class="tabs-bet-auto" data-path="panel-one">
                                            ...
                                            <label class="tabs-bet-auto__tab tabs-bet-auto__tab-1" translate="<?php if($game->name=='aerobet'): ?>auto_button<? else: ?>bet_button<?php endif; ?>" for="tabs-bet-auto__radio-1"><?php if($game->name=='aerobet'): ?>Auto<? else: ?>Bet<?php endif; ?></label>
                                        ...
                                        <div class="flex bet-wrap">
                                            ...
                                            <input class="number-input bet-input"
                                                   ...
                                                   step="<?php echo ($currency->moon_min_bet ?? 0.1)/10; ?>"
                                                    min="<?php echo $currency->moon_min_bet ?? 0.1; ?>"
                                                    max="<?php echo min(auth::user()->office->bet_max,$currency->moon_max_bet ?? 100); ?>"
                                                    autocomplete="off"
                                            ...
                                            <div class="flex btns-bet-wrap">
                                                <?php $bet_values=[10,20,50,100]; ?>
                                                <?php if($game->name=='aerobet'): ?>
                                                    <?php $bet_values=[10,50,100,200,500]; ?>
                                                <?php endif; ?>

                                                <?php foreach($bet_values as $bV): ?>
                                                    <button type="button" class="btn-multi" data-ctrl="1"
                                                            data-number="<?php echo $currency->formatBet($bV,true); ?>">
                                                        <?php echo ($game->name=='aerobet'?'+ ':'').$currency->formatBet($bV); ?>
                                                    </button>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                ...
                                <div class="flex content-top__control-panel-inner">
                                    ...
                                    <div class="flex bet-control-wrap">
                                        <div class="tabs-bet-auto" data-path="panel-two">
                                            ...
                                            <span class="tabs-bet-auto__active"></span>
                                            <label class="tabs-bet-auto__tab tabs-bet-auto__tab-3" translate="<?php if($game->name=='aerobet'): ?>auto_button<? else: ?>bet_button<?php endif; ?>" for="tabs-bet-auto__radio-3"><?php if($game->name=='aerobet'): ?>Auto<? else: ?>Bet<?php endif; ?></label>
                                ...
                                <div class="flex content-top__control-panel-inner">
                                    ...
                                    <div class="flex bet-control-wrap">
                                        <div class="tabs-bet-auto" data-path="panel-three">
                                            ...
                                            <span class="tabs-bet-auto__active"></span>
                                            <label class="tabs-bet-auto__tab tabs-bet-auto__tab-5" translate="<?php if($game->name=='aerobet'): ?>auto_button<? else: ?>bet_button<?php endif; ?>" for="tabs-bet-auto__radio-5"><?php if($game->name=='aerobet'): ?>Auto<? else: ?>Bet<?php endif; ?></label>
...
<!--                </div>-->
        ...
        <script src="/games/agt/moon/aerobet.js?v=<?php echo th::ver(); ?>1"></script>
        <?php else: ?>
...
//                StateLoad.fsPopup.onChildInputDown.dispatch({'act':'accept'});
            ...
            <?php if(in_array(auth::user()->office_id,[1029,1038,1041,1043,1045,1046,1047,1050,1117,1120,1201,1219,1213,1497,2172])): ?>
                window.whitelogo = '1029';
            <?php elseif(INFINSOC_DOMAIN): ?>
                window.whitelogo = '2220';
            <?php elseif($game->name=='aerobet'): ?>
            ...
            moonGame.moon_min_bet=<?php echo ($currency->moon_min_bet??0.1); ?>;
            moonGame.moon_max_bet=<?php echo min(auth::user()->office->bet_max,$currency->moon_max_bet ?? 100); ?>;
            moonGame.moon_max_win=<?php echo ($currency->moon_max_win??10000); ?>;
            moonGame.default_amount=<?php echo ($currency->moon_min_bet??0.1)*10; ?>;
        ...
        <?php if($game->name=='aerobet'): ?>
            <link rel="stylesheet" href="/games/agt/moon/css/aerobet.css?v=<?php echo th::ver(); ?>2">
        <?php endif; ?>
