    ...
    <head>
        ...
        <script>
            ...
            document.addEventListener('touchend', function (event) {
                ...
                <?php if(in_array(auth::user()->office_id,[1029,1038,1041,1043,1045,1046,1047,1050,1117,1120,1201,1219,1213,1497,2172,1672]) || ($name=='betssonlkl')): ?>
...
<!--            <script src="js/lib/ping.js?v=<?php echo th::ver(); ?>">
            ...
            <!--<script src="js/lib/fluid.js?v=<?php echo th::ver(); ?>">
            </script>-->
<!--            <script src="js/lib/neonRect.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/comps/ui/promoPopup.js?v=<?php echo th::ver(); ?>">
            </script>
            <script src="js/comps/ui/bonusBuyPopup.js?v=<?php echo th::ver(); ?>">
            </script>
            ...
            <script src="js/comps/ui/buttons/prizeButton.js?v=<?php echo th::ver(); ?>">
            </script>
            <script src="js/comps/ui/buttons/bonusBuyButton.js?v=<?php echo th::ver(); ?>">
            </script>
...
<!--            <script src="js/comps/info/buttonsMobile.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/comps/slot/pagearea2.js?v=<?php echo th::ver(); ?>">
            </script>
...
<!--            <script src="js/lib/phaser.min.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/lib/phaser2.20.min.js?v=<?php echo th::ver(); ?>">
            </script>
			<script src="js/lib/phaser-spine3.8.js?v=<?php echo th::ver(); ?>">
            </script>
            <script src="js/lib/phaser-nocache.min.js?v=<?php echo th::ver(); ?>">
