    ...
    <head>
        ...
        <script>
            ...
            <?php endif; ?>
                ...
                <?php if(in_array(auth::user()->office_id,[1029,1038,1041,1043,1045,1046,1047,1050,1117,1120])): ?>
...
<!--            <script src="js/lib/neonRect.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/comps/ui/buttons/resetButton.js?v=<?php echo th::ver(); ?>">
            </script>
...
<!--            <script src="js/comps/info/buttonsMobile.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/comps/slot/minerarea.js?v=<?php echo th::ver(); ?>">
            </script>
