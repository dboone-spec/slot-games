...
<html lang="en" translate="no">
    <head>
        ...
        <script>
            ...
            window.gametype = '<?php echo $gametype=='slot'?'slots':$gametype; ?>';
            ...
            document.addEventListener('touchend', function (event) {
                ...
                <?php if(in_array(auth::user()->office_id,[1029,1038,1041,1043,1045,1046,1047,1050,1117,1120,1201])): ?>
        ...
        <?php if(arr::get($_GET,'everymatrix6')): ?>
            <script src="js/everymatrix.js?v=<?php echo th::ver(); ?>">
            </script>
        <?php endif; ?>
		<script src="/js/fingerprint.js?v=<?php echo th::ver(); ?>">
        </script>
...
<!--            <script src="js/lib/phaser2151.min.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/lib/phaser2180.js?v=<?php echo th::ver(); ?>">
            </script>
...
<!--            <script src="js/comps/info/buttonsMobile.js?v=<?php echo th::ver(); ?>">
            ...
            <?php if($gametype=='slot'): ?>
            <script src="js/comps/slot/area.js?v=<?php echo th::ver(); ?>">
            </script>
            <?php elseif($gametype=='roshambo'): ?>
            <script src="js/comps/slot/roshamboarea.js?v=<?php echo th::ver(); ?>">
            </script>
            <?php elseif($gametype=='shuffle'): ?>
            <script src="js/comps/slot/shufflearea.js?v=<?php echo th::ver(); ?>">
            </script>
            <?php endif; ?>
...
<!--            <script src="js/lib/phaser.min.js?v=<?php echo th::ver(); ?>">
            ...
            <script src="js/lib/phaser2.20.min.js?v=110424">
            </script>
			<script src="js/lib/phaser-spine3.8.js?v=<?php echo th::ver(); ?>">
            </script>
            <script src="js/lib/phaser-nocache.min.js?v=110424">
            </script>
            <script src="js/lib/zepto.min.js?v=<?php echo th::ver(); ?>">
            </script>
...
//                checkGO();
                ...
                $(window).on('resize',function() {
                    ...
                    $('#iOSFullscreen').css('z-index','6997');
                    ...
                    if(window.outerHeight>window.innerHeight+(window.outerHeight*0.125)) {
                        ...
                        $('#iOSFullscreen').css('z-index','7000');
