                ...
                <div class="col-sm-12">
                    <form method="GET" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-default" href="<?php echo $dir ?>/userbet">Очистить</a>
                            <a class="btn btn-default export" onclick='window.open("<?php echo $dir ?>/userbet/" + (window.location.search.length != 0 ? window.location.search + "&export=1" : "?export=1"));' >Экспорт в CSV</a>
                        </div>
                    </form>
                </div>
            </div>
