...
<div class="pagination-cover">
    <ul class="pagination">
        ...
        <li class="pagination-item item-prev"><a href="<?php echo HTML::chars($page->url($previous_page)) ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
        <?php endif; ?>
        <?php foreach($links as $number => $content): ?>
        <li class="pagination-item <?php if($number === $current_page): ?>active<?php endif ?>">
            <a href="<?php echo HTML::chars($page->url($number)) ?>"><?php echo $content ?></a>
        </li>
        <?php endforeach; ?>
        <?php if($next_page !== FALSE): ?>
        <li class="pagination-item item-next"><a href="<?php echo HTML::chars($page->url($next_page)) ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
        <?php endif; ?>
    </ul>
</div>